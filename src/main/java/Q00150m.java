 ...
 */
public class Q00150m {
    public static void main(String[] args) {
        Q00150m q00150m = new Q00150m();
        String[] array1 = new String[]{"2", "1", "+", "3", "*"};
        String[] array2 = new String[]{"4", "13", "5", "/", "+"};
        String[] array3 = new String[]{"10", "6", "9", "3", "+", "-11", "*", "/", "*", "17", "+", "5", "+"};
        System.out.println(q00150m.evalRPN(array1));
        System.out.println(q00150m.evalRPN(array2));
        ...
        for (String item : tokens) {
            switch (item) {
                ...
                case "/":
                    ...
                    break;
                default:
                    stack[index++] = Integer.parseInt(item);
            }
        }
        return stack[0];
    }
